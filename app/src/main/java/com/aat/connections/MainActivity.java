...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            for(int i=0; i<connectionFileJson.length(); i++){
                ...
                connURL.add(url);
                String resp = jsonGetter(connectionFileJson.getJSONArray(i),"res").toString();
                response.add(resp);
            }
    ...
    private void updateClock() {
        TextView textTim = findViewById(R.id.textTime);
        textTim.setText(GetTime());
    }

    // check for connectivity using ICMP
    public static class pingICMP extends AsyncTask<Void, String, Integer> {
        private String ip1;
        ...
        protected Integer doInBackground(Void ...params) {
            ...
            try {
                code = in1.isReachable(timeoutReachable);
            } catch (Exception e) {
                code = false;
            }
            return 1;
    ...
    private boolean checkInternetConnection() {
        ...
        TextView connAvail = findViewById(R.id.textAvail);
    ...
    public static String GetTime() {
        ...
        return formathr + ":" + formatmin + ":" + formatsec;
    }
